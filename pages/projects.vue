        ...
        <div class="mt-6 lg:mt-10 border-b border-gray-400">
          <div class="border-t border-gray-400 py-6 sm:py-8 lg:py-10">
            <div class="lg:flex items-center justify-between">
              <div>
                <h3 class="text-gray-900 sm:text-lg lg:text-xl"><a href="/" class="hover:underline">Heroicons</a></h3>
              ...
              <div class="flex flex-wrap text-gray-900 text-sm sm:text-base lg:text-lg mt-2 sm:mt-3 lg:mt-0">
                <div class="lg:ml-8">
                  <a href="/" class="flex items-center group hover:underline">
          ...
          <div class="border-t border-gray-400 py-6 sm:py-8 lg:py-10">
            <div class="lg:flex items-center justify-between">
              <div>
                <h3 class="text-gray-900 sm:text-lg lg:text-xl">Hero Patterns</h3>
                <div class="flex text-gray-700 text-sm sm:text-base lg:text-lg mt-2 sm:mt-3 lg:mt-3">
          ...
          <div class="border-t border-gray-400 py-6 sm:py-8 lg:py-10">
            <div class="lg:flex items-center justify-between">
              <div>
                <h3 class="text-gray-900 sm:text-lg lg:text-xl">Zondicons</h3>
                <div class="flex text-gray-700 text-sm sm:text-base lg:text-lg mt-2 sm:mt-3 lg:mt-3">
